...
const OUT_DIR = path.join(ROOT, "review", "prototype", "screenshots");
const manifestPath = path.join(ROOT, "review", "prototype", "manifest.json");

const pages = [
  { slug: "home", url: `${BASE}/index.html`, mid: 1300 },
  { slug: "pistols", url: `${BASE}/pistols/index.html`, mid: 1200 },
  { slug: "reaper", url: `${BASE}/pistols/reaper.html`, mid: 1300 },
  { slug: "truth", url: `${BASE}/truth.html`, mid: 1100 },
  { slug: "stories", url: `${BASE}/stories.html`, mid: 1300 },
  { slug: "contact", url: `${BASE}/contact.html`, mid: 1250 }
];
...
console.log(`Captured ${manifest.length} prototype screenshots to ${OUT_DIR}`);
